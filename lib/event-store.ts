...
const initialEvents = [
  ...
  },
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/beach-cleanup-volunteer-day-Wd9Ij9Yx9Ij9Yx.jpg",
    description:
      "[SAMPLE EVENT] Join us for a day of environmental action! Help clean up our local beach and protect marine life. All cleaning supplies provided.",
    location: "Santa Monica Beach, California",
    coordinates: [34.019, -118.4914],
    category: "nature",
    creator: {
      id: "109",
      name: "Eco Warriors",
    ...
    participants: ["109"],
    requirements: [
      { id: "1", type: "Equipment", description: "Extra gloves and trash bags", filled: false },
      { id: "2", type: "Refreshments", description: "Water and snacks for volunteers", filled: false },
    ],
  },
  {
    id: "sample-10",
    title: "City Chess Tournament",
    date: new Date("2025-09-12T10:00:00"),
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/chess-tournament-Wd9Ij9Yx9Ij9Yx.jpg",
    description:
      "[SAMPLE EVENT] Calling all chess enthusiasts! Join our city-wide chess tournament with players of all skill levels. Prizes for winners in different categories.",
    location: "Central Library, Chicago",
    coordinates: [41.8781, -87.6298],
    category: "education",
    creator: {
      id: "110",
    ...
    participants: ["110"],
    requirements: [
      { id: "1", type: "Equipment", description: "Extra chess boards and timers", filled: false },
      { id: "2", type: "Volunteers", description: "Tournament judges and organizers", filled: false },
    ],
  },
  {
    id: "sample-11",
    title: "Pool Tournament & Social",
    date: new Date("2025-10-05T19:00:00"),
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pool-tournament-Wd9Ij9Yx9Ij9Yx.jpg",
    description:
      "[SAMPLE EVENT] Show off your pool skills at our friendly tournament! All skill levels welcome. Food and drinks available, plus prizes for winners.",
    location: "The Cue Club, Las Vegas",
    coordinates: [36.1699, -115.1398],
    category: "sports",
    creator: {
      id: "111",
      name: "Vegas Pool League",
      avatar: "/placeholder.svg?height=40&width=40",
      createdEvents: [1, 2],
      sponsoredEvents: [],
    },
    ...
    participants: ["111"],
    requirements: [
      { id: "1", type: "Prizes", description: "Trophy and gift cards for winners", filled: false },
      { id: "2", type: "Food", description: "Snacks and appetizers for participants", filled: false },
    ],
  },
]
